                ...
                bids.map((bid, key) => {
                    return(
                        <div key={key} className="max-w-sm p-6 bg-white border  rounded-lg shadow  border-gray-700">
                            ...
                            <p className="mb-3 font-normal  text-gray-400">{bid.item } </p>
                            <div className="flex gap-5">
                            <p className="mb-3 font-normal  text-gray-400">Qty: {bid.quantity}</p>
                            <p className="mb-3 font-normal  text-gray-400">Budget: ${bid.budget}</p>
                            </div>
                            <small className="mb-3 font-normal text-gray-400">
                            Apply before: {new Date(bid.due_date).toLocaleDateString()}
                            </small><br />
